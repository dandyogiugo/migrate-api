...
namespace DapperLayer.utilities
{
    public static class connectionManager
    {
        ...
        public static string search_query { get; } = @"SELECT DISTINCT prod.CustomerID,Customer.FullName,Customer.Email,Customer.Phone,Customer.Occupation,Customer.Data_source,
...
;";
        ...
        public static string recomendation { get; } = @"SELECT Product_recommended,Scored_probability FROM [ABS_MEMO].[dbo].[Recommended_products] where CustomerID = @customer_id
